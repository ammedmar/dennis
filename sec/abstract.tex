...
\begin{abstract}
	...
	Over the rational numbers, $C_\infty$-coalgebra structures control the $\Q$-complete homotopy theory of spaces, and over the integers, $E_\infty$-coalgebras provide an appropriate setting to model the full homotopy category.
